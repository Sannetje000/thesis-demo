...
<span style='color:#378ADD; font-size:1.2em'>●</span> <b style='color:#A0C8EA'>Content</b> — sentences describing the story, characters, or setting<br>
<span style='color:#E08070; font-size:1.2em'>●</span> <b style='color:#EFAF9A'>Non-content</b> — promotional text, author credits, critic quotes, or metadata
</p>
